...
preact.h("option",{key:m.name,value:toID(m.name)},
...
var id=toID(item);
return preact.h("option",{key:id,value:id,disabled:takenItems(selectedPokemon.uid).has(item)},
item
);
})
),
